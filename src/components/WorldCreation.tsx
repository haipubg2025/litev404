...
Dữ liệu trả về PHẢI là một object JSON duy nhất với cấu trúc chính xác sau:
{
  ...
  "npcs": [{
    ...
    "appearanceLite": "Miêu tả tóm tắt ngắn gọn ngoại hình để AI dễ ghi nhớ (BẮT BUỘC có ít nhất 5 câu mô tả đầy đủ nhưng ngắn gọn. CHỈ CÓ NỘI DUNG SFW, KHÔNG KÈM TRANG PHỤC)",
    "powers": [{"name": "Tên năng lực/sức mạnh", "description": "Mô tả chi tiết năng lực", "type": "Loại năng lực", "level": "Cấp độ (nếu có)"}], 
    "skills": [{"name": "Tên kỹ năng", "description": "Mô tả chi tiết", "type": "Loại kỹ năng", "level": "Độ thuần thục"}], 
                  ...
                  <div className="space-y-8">
                    ...
                    <section className="space-y-4">
                      <CharacterTextArea 
                        ...
                        description="Thời điểm cụ thể mà câu chuyện bắt đầu diễn ra (ví dụ: Năm 2045, Kỷ nguyên Ánh sáng thứ 3, Ngày thứ 7 sau Thảm họa Vẫn thạch)."
                      />
                    </section>
                ...
                <div className="space-y-12">
                  ...
                  <button 
                    onClick={() => setNpcs([...npcs, { 
                      name: '', fullName: '', titles: '', occupation: '', gender: '', age: '', dob: '', height: '', weight: '', measurements: '', appearance: '', appearanceLite: '', background: '', rank: '', powers: [], skills: [], role: '', personality: '', personalityCore: '', philosophy: '', distinguishingFeatures: '', innerSecret: '', relationships: [], loveViews: '', experience: '', nsfwPersonality: '', nsfwReactions: '', literaryDescription: '', goal: ''
                    }])}
